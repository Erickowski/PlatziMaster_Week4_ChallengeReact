                ...
                <nav className="menu__nav">
                    <ul className="menu__nav--list">
                        <li>
                            ...
                            <svg onClick={() => this.setState({nav: 'off'})} xmlns="http://www.w3.org/2000/svg" width="16" height="15">
                        ...
                        <li>
                            <img src="src\assets\static\icon-facebook.svg" alt=""/>
                            <img src="src\assets\static\icon-twitter.svg" alt=""/>
                        </li>
                    </ul>
                </nav>
            </header>
